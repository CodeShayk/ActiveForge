...
{
    /// <summary>
    /// Turquoise.ORM DataConnection implementation for MongoDB.
    ...
    public class MongoDataConnection : DataConnection, IDisposable
    {
        ...
        private FieldSubset UpdateInternal(DataObject obj)
        {
            ...
            return new global::Turquoise.ORM.FieldSubset(obj, global::Turquoise.ORM.FieldSubset.InitialState.IncludeAll, null);
        }
        ...
        public override FieldSubset DefaultFieldSubset(DataObject rootObject)
            => new global::Turquoise.ORM.FieldSubset(rootObject, global::Turquoise.ORM.FieldSubset.InitialState.IncludeAll, null);

        public override FieldSubset FieldSubset(DataObject rootObject, global::Turquoise.ORM.FieldSubset.InitialState state)
            => new global::Turquoise.ORM.FieldSubset(rootObject, state, null);

        public override FieldSubset FieldSubset(DataObject rootObject, DataObject enclosing, TField enclosed)
            => new global::Turquoise.ORM.FieldSubset(rootObject, global::Turquoise.ORM.FieldSubset.InitialState.ExcludeAll, null);

        public override FieldSubset FieldSubset(DataObject rootObject, DataObject enclosing, DataObject enclosed)
            => new global::Turquoise.ORM.FieldSubset(rootObject, global::Turquoise.ORM.FieldSubset.InitialState.IncludeAll, null);

        public override FieldSubset FieldSubset(DataObject rootObject, DataObject enclosing, DataObject enclosed, global::Turquoise.ORM.FieldSubset.InitialState state)
            => new global::Turquoise.ORM.FieldSubset(rootObject, state, null);
        ...
        {
            var counters = Database.GetCollection<BsonDocument>("__turquoise_counters");
