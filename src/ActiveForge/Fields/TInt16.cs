...
{
    /// <summary>
    /// ORM field that wraps the CLR <see cref="short"/> (16-bit signed integer) type,
    /// mapping to a SMALLINT database column.
    /// <para>
    /// Use <see cref="TField.SetValue(object)"/> or the typed overload
    /// <see cref="SetValue(short)"/> to assign a value, <see cref="TField.GetValue()"/>
    /// to retrieve it as <see cref="object"/>, or rely on the implicit conversions
    /// between <c>TInt16</c> and <c>short</c> for transparent usage.
    /// </para>
    /// </summary>
    [Serializable]
    ...
    public class TInt16 : TField, IComparable
    {
        ...
        /// <summary>Initialises a new <see cref="TInt16"/> with a value of zero and null state unset.</summary>
        public TInt16()           { InnerValue = 0; }

        /// <summary>Initialises a new <see cref="TInt16"/> with the specified <paramref name="v"/> value.</summary>
        /// <param name="v">The initial short value.</param>
        public TInt16(short v)    { SetValue(v); }

        /// <summary>
        /// Initialises a new <see cref="TInt16"/> by converting <paramref name="v"/> using
        /// <see cref="TField.SetValue(object)"/>.
        /// </summary>
        /// <param name="v">Any value that can be converted to <see cref="short"/>.</param>
        public TInt16(object v)   { SetValue(v); }

        /// <summary>Implicitly converts a <see cref="TInt16"/> to its underlying <see cref="short"/> value.</summary>
        /// <param name="t">The field instance to convert.</param>
        public static implicit operator short(TInt16 t) => t.InnerValue;

        /// <summary>Implicitly wraps a <see cref="short"/> literal or variable in a new <see cref="TInt16"/>.</summary>
        /// <param name="v">The short value to wrap.</param>
        ...
        /// <summary>Returns <see cref="short"/> as the underlying CLR type of this field.</summary>
        public override Type   GetUnderlyingType()  => typeof(short);

        /// <summary>Returns the string token <c>"int16"</c> used by the ORM schema system.</summary>
        public override string GetTypeDescription()  => "int16";

        /// <summary>Returns the current value as a boxed <see cref="short"/>.</summary>
        public override object GetValue()            => InnerValue;

        /// <summary>
        /// Sets the backing value from an arbitrary <see cref="object"/>.
        /// Accepts a <see cref="TInt16"/> (copies its inner value) or anything
        /// convertible via <see cref="Convert.ToInt16(object)"/>.
        /// </summary>
        ...
        /// <summary>Returns the default string representation of the current short value.</summary>
        public override string ToString() => InnerValue.ToString();

        /// <summary>
        /// Compares this instance to <paramref name="obj"/>.
        /// Accepts a <see cref="TInt16"/> or any value convertible to <see cref="short"/>.
        /// </summary>
        ...
        /// <summary>Returns zero when null; otherwise delegates to <see cref="short.GetHashCode()"/>.</summary>
