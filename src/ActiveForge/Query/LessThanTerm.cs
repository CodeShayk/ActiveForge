...
{
    /// <summary>
    /// A leaf <see cref="QueryTerm"/> that generates a less-than predicate of the form
    /// <c>alias.column &lt; @IN_column&lt;n&gt;</c>.
    /// Useful for filtering rows where a numeric, date, or comparable field falls strictly
    /// below a given threshold value (exclusive upper bound).
    /// </summary>
    public class LessThanTerm : QueryTerm
    {
        /// <summary>
        /// Initialises a new <see cref="LessThanTerm"/> for the specified field and value.
        /// </summary>
        /// <param name="target">
        ...
        /// <param name="value">
        /// The exclusive upper-bound value. Passed through the field's <c>FieldMapper</c> and
        /// optional encryption layer before being bound to the command parameter.
        /// </param>
        public LessThanTerm(Record target, TField field, object value) : base(target, field, value) { }
        ...
        /// </param>
        /// <returns>A <see cref="QueryFragment"/> containing the less-than predicate.</returns>
        ...
        /// <summary>
        /// Generates the SQL less-than fragment for use inside a DELETE statement's
        ...
        /// Running counter used to generate a unique parameter name suffix; incremented once.
        /// </param>
        /// <returns>A less-than predicate string suitable for DELETE SQL.</returns>
