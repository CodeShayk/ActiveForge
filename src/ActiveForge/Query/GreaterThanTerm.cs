...
{
    /// <summary>
    /// A leaf <see cref="QueryTerm"/> that generates a greater-than predicate of the form
    /// <c>alias.column &gt; @IN_column&lt;n&gt;</c>.
    /// Useful for filtering rows where a numeric, date, or comparable field exceeds a
    /// given threshold value.
    /// </summary>
    public class GreaterThanTerm : QueryTerm
    {
        /// <summary>
        /// Initialises a new <see cref="GreaterThanTerm"/> for the specified field and value.
        /// </summary>
        /// <param name="target">
        ...
        /// <param name="value">
        /// The threshold value. Passed through the field's <c>FieldMapper</c> and optional
        /// encryption layer before being bound to the command parameter.
        /// </param>
        public GreaterThanTerm(Record target, TField field, object value) : base(target, field, value) { }
        ...
        /// </param>
        /// <returns>A <see cref="QueryFragment"/> containing the greater-than predicate.</returns>
        ...
        /// <summary>
        /// Generates the SQL greater-than fragment for use inside a DELETE statement's
        ...
        /// Running counter used to generate a unique parameter name suffix; incremented once.
        /// </param>
        /// <returns>A greater-than predicate string suitable for DELETE SQL.</returns>
