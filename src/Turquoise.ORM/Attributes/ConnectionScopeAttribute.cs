...
namespace Turquoise.ORM.Attributes
{
    ...
    /// <see cref="Turquoise.ORM.Transactions.ConnectionScopeInterceptor"/> automatically opens the
    ...
    /// </para>
    /// <para>
    /// When used together with <see cref="Turquoise.ORM.Transactions.TransactionAttribute"/>,
