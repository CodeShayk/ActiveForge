...
namespace Turquoise.ORM.Transactions
{
    ...
    /// <see cref="ITurquoiseBuilder.AddServices"/> on the builder returned by
    /// <c>AddTurquoiseSqlServer</c> / <c>AddTurquoisePostgreSQL</c> / <c>AddTurquoiseMongoDB</c>.
    /// </summary>
    public static class TurquoiseServiceCollectionExtensions
    {
        /// <summary>
        ...
        /// </para>
        /// </summary>
        public static IServiceCollection AddTurquoiseService<TService>(
            ...
            where TService : class
        {
            ...
            services.AddScoped<TService>(sp =>
            {
                ...
                return TurquoiseServiceFactory.Create(instance, connection, unitOfWork, logger);
            });
        ...
        /// </typeparam>
        public static IServiceCollection AddTurquoiseService<TInterface, TImplementation>(
            this IServiceCollection services)
            ...
            where TImplementation : class, TInterface
        {
            ...
            services.AddScoped<TInterface>(sp =>
            {
                ...
                return (TInterface)TurquoiseServiceFactory.Create(
