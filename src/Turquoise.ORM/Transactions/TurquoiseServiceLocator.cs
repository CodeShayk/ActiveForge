...
namespace Turquoise.ORM.Transactions
{
    ...
    /// </summary>
    public static class TurquoiseServiceLocator
    {
        ...
        public static T Resolve<T>()
        {
            if (_provider != null)
            {
                ...
                if (svc == null)
                    throw new InvalidOperationException(
                        $"TurquoiseServiceLocator: no service registered for {typeof(T).FullName}. " +
            ...
            throw new InvalidOperationException(
                "TurquoiseServiceLocator has not been initialised. " +
                "Call TurquoiseServiceLocator.SetProvider(IServiceProvider) at startup.");
        }
