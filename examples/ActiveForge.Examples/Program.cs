...
using ActiveForge.Examples.Examples;
using ExampleTransactions = ActiveForge.Examples.Examples.Transactions;

namespace ActiveForge.Examples
{
    /// <summary>
    /// ActiveForge — Interactive example runner.
    ///
    /// SETUP — SQL Server
    /// ──────────────────
    ...
    internal static class Program
    {
        ...
        static void PrintBanner()
        {
            ...
            Console.WriteLine("╔══════════════════════════════════════════╗");
            Console.WriteLine("║      ActiveForge  — Examples App       ║");
            Console.WriteLine("╚══════════════════════════════════════════╝");
            Console.ResetColor();
        }
